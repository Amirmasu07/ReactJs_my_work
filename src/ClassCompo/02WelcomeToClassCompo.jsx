        ...
        return (
            <>
                <div className='class-content mt-2 border-top'>
                    <h4 className='text-dark border-bottom py-2 fw-bold'>--- Welcome To Class Components</h4>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            <p>
                                <span className='text-primary'>class</span> <span className='text-success'>Class Components</span> <span className="text-primary">extends</span>
                                <span className="text-success">Component</span> <span className="text-warning">&#123;</span> <br /> <span className="text-warning ms-3">render</span>
                                <span className="text-danger">&#40;&#41; &#123;</span> <br /> <span className="text-danger ms-4">return</span> <span className="text-info">&#40;</span> <br />
                                ...
                                <span className="text-info ms-4">&#41;</span>; <br /> <span className="text-danger ms-3">&#125;</span> <br /> <span className="text-warning">&#125;</span>;
                            </p>
                        </li>
                    </ul>
                </div>
