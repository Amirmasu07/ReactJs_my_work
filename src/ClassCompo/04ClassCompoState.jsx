            ...
            return (
                <>
                    <div className="class-content mt-2 border-top">
                        <h4 className='text-dark border-bottom py-2 fw-bold'>State:</h4>
                        <ul className='sub-content'>
                            ...
                            <li>
                                ...
                                <p className="bg-info bg-opacity-10 py-3 px-4 border border-info">
                                    ...
                                    <span className="text-warning ms-3">constructor</span><span className="text-danger">&#40;props&#41; &#123;</span> <br /> <span className="text-danger ms-4">super</span> <span className="text-info">&#40;props&#41;</span>; <br />
                                    <span className="text-danger ms-3">&#125;</span> <br /> <span className="text-primary ms-4">this.</span><span className="text-info">state<span className='ms-2'>&#61;</span> </span><span className="text-primary ms-2">&#123;</span>
                                    <span className="text-info">data:</span> <span className="text-danger">	&quot;Something	&quot;</span><span className="text-primary">&#125;</span> <br /><span className="text-warning">&#125;</span>
                                </p>
                            </li>
                        </ul>
                    </div>
...
//                         </li>
//                         <li>
//                             <div><strong>State</strong>&nbsp; {this.state.data}</div>
//                         </li>
//                     </ul>
//                 </div>
//             </>
